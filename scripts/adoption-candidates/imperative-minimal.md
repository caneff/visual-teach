---
name: visual-teach
description: "On every teaching lesson, link the `visual-teach` Base first, then use ready-made `vt-*` blocks for the standard parts. Applies to any lesson HTML (especially `/teach`), including heavily custom or interactive ones."
---
